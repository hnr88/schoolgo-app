...
export function WaitlistRow({
  ...
  return (
    <li className='flex items-center gap-4 rounded-xl bg-gray-50 px-4 py-3'>
      <span className='flex h-8 w-8 shrink-0 items-center justify-center rounded-pill bg-card text-xs font-bold tabular-nums text-ink-900'>
        {entry.rank ?? '—'}
      </span>
