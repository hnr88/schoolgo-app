...
import { getSchoolAvatarColor, getSchoolInitials } from '@/modules/design-system/lib/school-avatar';
  ...
  if (name) {
    return (
      <div
        ...
        aria-hidden='true'
      >
        <span className='text-2xl font-bold'>{getSchoolInitials(name)}</span>
      </div>
    );
  }
