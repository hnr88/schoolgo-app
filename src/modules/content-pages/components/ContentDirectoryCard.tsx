...
export function ContentDirectoryCard({
  ...
  return (
    <Link
      ...
      className='group flex h-full flex-col overflow-hidden rounded-lg border border-border bg-card no-underline shadow-1 transition-[transform,box-shadow] duration-300 hover:-translate-y-1 hover:shadow-3'
    >
