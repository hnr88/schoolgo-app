...
export function ContentLinkPanel({ links }: { links: ContentLink[] }) {
  return (
    <section id='links' className='bg-muted py-16 md:py-20'>
      <SectionContainer>
        <SectionHeader
          ...
          subheading='These links make the dummy pages feel like a connected content system rather than isolated mockups.'
        />
