...
export const LIFECYCLE_STYLES: Record<string, BadgeStyle> = {
  ...
  issued: { dot: 'bg-vivid-mint', bg: 'bg-vivid-mint-soft', text: 'text-vivid-mint-strong' },
  started: { dot: 'bg-vivid-mint', bg: 'bg-vivid-mint-soft', text: 'text-vivid-mint-strong' },
...
export const BUCKET_STYLES: Record<string, BadgeStyle> = {
  ...
  ok: { dot: 'bg-vivid-mint', bg: 'bg-vivid-mint-soft', text: 'text-vivid-mint-strong' },
  unknown: { dot: 'bg-foggy/50', bg: 'bg-muted', text: 'text-foggy' },
};
