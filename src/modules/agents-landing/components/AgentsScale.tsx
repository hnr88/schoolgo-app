                  ...
                  >
                    <article className='flex min-w-0 flex-col gap-3 rounded-xl border border-border bg-card p-4 shadow-2 transition-shadow hover:shadow-3 sm:p-5'>
                      <div className='flex min-w-0 flex-wrap items-center gap-3'>
                        <div className='relative h-12 w-12 shrink-0 overflow-hidden rounded-pill border border-border bg-card'>
                          {school.logoUrl ? (
                            <Image
                              src={school.logoUrl}
                              alt=''
                            ...
                            <div
                              className='flex h-full w-full items-center justify-center text-body-sm font-bold text-white'
