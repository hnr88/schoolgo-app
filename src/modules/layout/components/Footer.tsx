...
export async function Footer() {
  ...
  return (
    <footer className='w-full mt-20 pt-12 pb-8 bg-muted'>
      <div className='grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-4 md:gap-x-6 px-12 max-w-content mx-auto'>
        <div className='flex items-center gap-5'>
          ...
          />
          <p className='text-caption font-medium text-foggy uppercase tracking-widest leading-relaxed pt-1'>
            {t('tagline')}
          </p>
        </div>
        ...
        <div className='flex flex-col gap-3'>
          ...
          {resourceLinks.map((link) => (
            <a
              key={link.label}
              href={link.href}
              className='text-caption font-medium text-foggy hover:text-primary underline decoration-2 underline-offset-4 transition-colors uppercase tracking-widest'
            >
              {link.label}
            </a>
          ))}
        ...
        <div className='flex flex-col gap-4'>
            ...
            <div className='flex gap-4'>
              {socialLinks.map(({ Icon, label, href }) => (
                  <a
                    ...
                    href={href}
                    aria-label={label}
                    className='text-foggy hover:text-primary transition-colors'
                  >
          ...
          <p className='text-caption-xs font-bold text-foggy uppercase tracking-widest'>
            {t('copyright', { year })}
          </p>
        </div>
      </div>
