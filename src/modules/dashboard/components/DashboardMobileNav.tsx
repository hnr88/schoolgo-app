    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogPortal>
        ...
        <DialogPrimitive.Popup
          ...
          className='fixed inset-y-0 left-0 z-50 flex w-72 max-w-full flex-col bg-rausch-50 shadow-3 outline-none duration-150 data-open:animate-in data-open:slide-in-from-left data-closed:animate-out data-closed:slide-out-to-left'
        >
