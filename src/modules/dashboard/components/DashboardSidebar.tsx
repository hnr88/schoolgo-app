...
export function DashboardSidebar() {
  ...
  return (
    <aside
      className={cn(
        'hidden h-full flex-col border-r border-background/10 bg-gradient-to-b from-rausch-800 via-arches-700 to-ink-900 transition-all duration-300 ease-out-quart lg:flex',
