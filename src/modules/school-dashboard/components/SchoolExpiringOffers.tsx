      ...
      <div className='flex flex-col divide-y divide-divider'>
        {offers.length === 0 ? (
          ...
          offers.map((offer) => (
            ...
            >
              <span className='flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-rausch-50 text-rausch-600'>
              ...
              <span className='shrink-0 rounded-full bg-rausch-50 px-2 py-0.5 text-xs font-semibold text-rausch-600 tabular-nums'>
