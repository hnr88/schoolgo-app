    ...
    <div className='relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6'>
      <div className='pointer-events-none absolute inset-0' aria-hidden='true'>
        ...
        <svg className='absolute inset-0 h-full w-full opacity-[0.04]'>
          <defs>
            <pattern id='school-agent-slug-nf-dots' width='32' height='32' patternUnits='userSpaceOnUse'>
              <circle cx='2' cy='2' r='1' fill='currentColor' />
            </pattern>
          </defs>
          <rect width='100%' height='100%' fill='url(#school-agent-slug-nf-dots)' />
        </svg>
      </div>

      <div className='relative flex max-w-lg flex-col items-center text-center'>
        <Link href='/school' className='mb-10' aria-label='SchoolGo home'>
          <Image
